...
public class DeviceInfoBuilder {
    ...
    public Device createDeviceInfo() {
        return new Device(ip, servicePort, deviceId, model, name, firmwareVersion, supportedActions, power, colorMode, bright, colorTemperature, rgb, hue, sat);
    }
}